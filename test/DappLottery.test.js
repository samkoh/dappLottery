...
describe('DappLottery', () => {
    ...
    describe('Buying of Tickets', () => {
        ...
        it('Should confirm ticket purchase', async () => {
            ...
            await contract.connect(participant1).buyTicket(lotteryId, numberToGenerate - 1, { value: ticketPrice })
    ...
    describe('Selecting Winners', () => {
        beforeEach(async () => {
            ...
            await contract.connect(participant1).buyTicket(lotteryId, numberToGenerate - 1, { value: ticketPrice })
            await contract.connect(participant1).buyTicket(lotteryId, numberToGenerate - 2, { value: ticketPrice })
            await contract.connect(participant1).buyTicket(lotteryId, numberToGenerate - 3, { value: ticketPrice })
            await contract.connect(participant1).buyTicket(lotteryId, numberToGenerate - 4, { value: ticketPrice })
            await contract.connect(participant1).buyTicket(lotteryId, numberToGenerate - 5, { value: ticketPrice })
        })
